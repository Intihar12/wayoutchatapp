...
// Pick an image.
                              ...
                              if (images.isNotEmpty) {
                                for (var i in images) {
                                  ...
                                  Apis.isgroup != true
                                      ? Apis.setChateImage(widget.user, File(i.path))
                                      : Apis.setChateImageInGroup(widget.user, File(i.path));
                                  setState(() {
                                    isUploadingImage = false;
                                  });
                                }
...
// Pick an image.
                              ...
                              if (image != null) {
                                ...
                                Apis.isgroup != true
                                    ? Apis.setChateImage(widget.user, File(image.path))
                                    : Apis.setChateImageInGroup(widget.user, File(image.path));
                                setState(() {
                                  isUploadingImage = false;
                                });
                              }
                  ...
                  onPressed: () {
                    if (textController.text.isNotEmpty) {
                      ...
                      if (_list.isEmpty) {
                        list[0].isGroup != true
                            ? Apis.sendFirstMessage(widget.user, textController.text, Type.text)
                            : Apis.sendGroupMessage(widget.user, textController.text, Type.text);
